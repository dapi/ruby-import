...
require "ruby/import/version"

Gem::Specification.new do |spec|
  spec.name          = "ruby-import"
  spec.version       = Ruby::Import::VERSION
  spec.authors       = ["Danil Pismenny"]
  spec.email         = ["danil@brandymint.ru"]

  spec.summary       = %q{ES7 style modules importing in Ruby.}
  spec.description   = %q{No litter global namespace, no states, no mixins.}
